...
/**
 * 
 * <b>类名称</b> :EntityFactory<br>
 * <b>类描述</b> :<br>
 * <b>创建人</b> : zhangjp<br>
 * <b>创建时间</b> : 2015-7-20 上午10:58:13<br>
 * <b>版本号</b> :1.0.0<br>
 ************************************<br>
 * <b>修改人	</b> :<br>
 * <b>修改时间</b> :<br>
...
public class EntityFactory {
	...
	private static String classPath = EntityFactory.class.getClassLoader().getResource("").getPath();
	static
	{
		try {
	...
	public void outputCoder(){
		...
		for(String _tab:this.list_table)
		{
			...
			_buffer.append("package "+this.pkg_path+".po;\n");
			_buffer.append("\n");
			String _tmpTab = getGeneralName(_tab);
			_buffer.append("public class "+_tmpTab+" extends BasePo {\n");
			_buffer.append("\n");
			try {
			...
			try {
				...
				java.io.File _ffff = new java.io.File(this.file_path+_tmpTab+".java");
				if(!_ffff.exists()){
					_ffff.delete();
				}
				FileUtils.String2File(_buffer, this.file_path+_tmpTab+".java", "UTF-8");
			} catch (IOException e) {
